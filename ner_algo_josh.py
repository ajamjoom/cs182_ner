...
print "Training Data Size: " + str(len(data_small))
print "Validation Data Size: " + str(len(data_valid))
...
<<<<<<< HEAD
# second dict csv reader, works the same
...
=======
>>>>>>> 1738bc064af8e8cfd43e9cf14b3e98e1186cccfc
...
=======
        prob = 0.0
>>>>>>> 4798ca289efb8a6ea6ec8d19ad38a0ff8b8b41d1
        max_prob = 0.0
        max_tag = ''
        for tag in tag_list:  
            # try, except to ignore one value when a word has not been seen before!
...
# Note: still requires a ton more testing. This is essentially the pipeline, but no significant results yet
